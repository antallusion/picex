  ...
  return (
    <div className="photos__card">
      <button
        ...
        onClick={() => dispatch({ type: CHECK, id: props.id })}
      >
        <div className="photos__container">
          <div className={`photos__check ${props.check ? 'photos__check--active' : ''}`}>
            {props.check && <Sprite icon="check-icon" width="38" height="38" />}
          </div>
          <img className="photos__image" ref={ref} alt="image" src={props.src} />
      ...
      <div className="photos__card-wrapper">
        ...
        <button className="photos__copy" onClick={() => navigator.clipboard.writeText(props.src)}>
      ...
      <div className="photos__bottom">
        ...
        <button
          ...
          onClick={() => download(props.size.buffer?.data, props.size.format, props.name)}
        >
